...
app.controller('NavigationController', function($scope, $location){
	...
	$scope.navigateToSilverHammer = function(){
		$scope.navigationMode = 'silverHammer';
	};

	$scope.is2ndGen = function(){
		return !$scope.navigationMode || $scope.navigationMode === '' || $scope.navigationMode === '2ndGen';
	};
